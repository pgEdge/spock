							...
							const SpockApplyProgress *sap)
{
	...
	{
		/*
		 * Initialize progress structure: zero all fields per convention.
		 * Follow this pattern in UpdateWorkerStats as well.
		 */
...
spock_group_resource_load(void)
{
	...
	/*
	 * NOTE:
	 * Following the logic to lock during redo, we should acquire the
	 * apply_group_master_lock. But update routine will do it. So, no extra
	 * locking needed.
	 */
