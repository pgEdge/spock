...
BEGIN
    ...
    -- Case B (ros.local_lsn > v_lsn): use pre_origin captured before slot creation.
    FOR rec IN (
        ...
        v_pre_origin_lsn := CASE
            WHEN v_pre_idx IS NOT NULL THEN v_pre_origin_lsns[v_pre_idx]
            ELSE '0/0'::pg_lsn
        END;
