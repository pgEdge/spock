...
BEGIN
    ...
    FOR rec IN (
        ...
        --         To reduce a tiny stale-read window on shared-memory ros,
        --         take one more immediate ros sample and keep the higher
        --         remote_lsn only when both samples are still <= v_lsn.
