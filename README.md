...
- Adding or Removing Nodes
  ...
  - Using Zodan
    ...
    - [Using Zodan (attach_node/detach_node and the SQL scripts)](docs/modify/zodan/zodan_readme.md)
...
The Spock extension provides multi-master replication for PostgreSQL versions 15, 16, 17, 18, and 19.  Take the following requirements into consideration as you design your cluster:
